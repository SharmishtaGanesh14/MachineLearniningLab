...
def My_Implementation(X_train, X_test, y_train, y_test):
    ...
    def gradient_descent(X_Train, X_Test, Y_Train, Y_Test, thetas):
        ...
        print("Bias Term:", float(thetas[0][0]))
...
def Scikitlearn( X_train, X_test, y_train, y_test):
...
def main():
    ...
    Scikitlearn(X_train, X_test, y_train, y_test)

    print("\n----------Done!----------\n")

    My_Implementation(X_train, X_test, y_train, y_test)
