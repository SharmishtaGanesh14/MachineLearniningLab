...
def main():
    ...
    print(f"R² score for Disease Score: {r2:.2f} (closer to 1 is better)")  # Print the result
    ...
    print(f"R² score for Disease Score Fluctuations: {r2:.2f} (closer to 1 is better)")  # Print the result
